...
For example, Peach [47] has a robust parser component called File Cracker can precisely parses and decomposes the file into chunks and attributes and provides the boundary indices and type information.

#### Smart Mutation Operators

- Smart Deletion
  Given a seed file s, choose an arbitrary chunk c and delete it.
  ![smart-deletion](image-5-1.png)
- Smart Addition
- Smart Splicing
